...
ax.set_title('Confusion Matrix Accuracy = ' + str(round(accuracy, 2)) + ' %' + ' with kNN for LOO experiment' + '\n\n')
ax.set_xlabel('\nPredicted Values')
ax.set_ylabel('Actual Values ')
ax.xaxis.set_ticklabels(['africa','conv','fact']); ax.yaxis.set_ticklabels(['africa', 'conv','fact']);
plt.show()

#save_multi_image("C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\LOOexp\\kNNresults\\LOOcmkNN.pdf")
