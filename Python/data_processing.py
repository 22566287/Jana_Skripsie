...
africa1 = read("./data/A1-E5-001.wav")
africa2 = read("./data/A2-E5-001.wav")
conv1 = read("./data/C1-E5-001.wav")
conv2 = read("./data/C2-E5-001.wav")
...
# energy = getEnergyInHarmonic(avPDSA1, f0A1, 1)
...
# energy = getEnergyInHarmonic(avPDSA2, f0A2, 1)
...
# energy = getEnergyInHarmonic(avPDSC1, f0C1, 1)
...
# energy = getEnergyInHarmonic(avPDSC2, f0C2, 1)
...
sub1.set_title('A1E5') # non OOP: plt.title('The function f')
