...
feat1, feat2, feat3, feat4 = [0]*42, [0]*42, [0]*42, [0]*42
...
violin = ["africa","africa","africa","africa","africa","africa",
...
pathOfFiles = "C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\DiffExp\\testSet"
files = os.listdir(pathOfFiles)
print(files)
splitValue = 6
audioArr = [0]*splitValue
frameCounter = -1

fs = 96000
#Read data from directory with specific file
path = "C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\DiffExp\\testSet"
for i in range(7):
    ...
    audioArr = timeFrame(audio, audioArr,splitValue)
    frameCounter = -1
 

    for m in range(splitValue):
        ...
        for k in range(4):
            # Meinel features
            feat1[splitValue*i + frameCounter] = getEnergyInHarmonic(AavPDSshort, f0val[k], 1,framelength, noteval[k])
            totalE1 = totalE1 + feat1[splitValue*i + frameCounter]

            feat2[splitValue*i + frameCounter] = getEnergyInHarmonic(AavPDSshort, f0val[k], 2,framelength, noteval[k])
            totalE2 = totalE2 + feat2[splitValue*i + frameCounter]

            feat3[splitValue*i + frameCounter] = getEnergyInHarmonic(AavPDSshort, f0val[k], 3,framelength, noteval[k])
            totalE3 = totalE3 + feat3[splitValue*i + frameCounter]

            feat4[splitValue*i + frameCounter] = getEnergyInHarmonic(AavPDSshort, f0val[k], 4,framelength, noteval[k])
            totalE4 = totalE4 + feat4[splitValue*i + frameCounter]
        ...
        feat1[splitValue*i + frameCounter] = totalE1
        feat2[splitValue*i + frameCounter] = totalE2
        feat3[splitValue*i + frameCounter] = totalE3
        feat4[splitValue*i + frameCounter] = totalE4
...
energyPath = 'C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\DiffExp\\classifierInput\\'
data.to_excel(energyPath + 'DiffTest.xlsx', sheet_name='sheet1', index=False)

read_file = pd.read_excel ('C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\DiffExp\\classifierInput\\DiffTest.xlsx')
read_file.to_csv ('C:\\Users\\Jana\\Documents\\Stellenbosch_Ingenieurswese\\Lesings\\2022\\2de_semester\\Project_E_448\\AudioAnalysisofanAfricanViolin\\violinData\\DiffExp\\classifierInput\\DiffTest.csv', index = None, header=True)
